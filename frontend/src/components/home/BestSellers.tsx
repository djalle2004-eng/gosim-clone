        ...
        <div className="flex justify-between items-end mb-14">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">
              الباقات <span className="bg-gradient-to-r from-violet-400 to-pink-400 bg-clip-text text-transparent">الأكثر مبيعاً</span>
            </h2>
          ...
          <div className="flex overflow-x-auto pb-8 gap-6 snap-x snap-mandatory lg:grid lg:grid-cols-4 lg:grid-flow-row lg:overflow-visible no-scrollbar">
            {plans?.map((plan: any, idx: number) => (
              ...
              >
                ...
                <div className="bg-gradient-to-b from-white/[0.06] to-white/[0.02] backdrop-blur-sm border border-white/[0.08] rounded-3xl p-6 relative overflow-hidden hover:border-violet-500/40 transition-all duration-500 hover:shadow-2xl hover:shadow-violet-500/10 flex flex-col h-full group-hover:-translate-y-2">
                  {/* Top decorative gradient */}
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-violet-600 via-pink-500 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-5 relative z-10">
                    <div className="bg-gradient-to-br from-white/[0.05] to-white/[0.02] rounded-2xl p-4 text-center border border-white/[0.05] group-hover:border-white/[0.08] transition-colors">
                    ...
                    <div className="bg-gradient-to-br from-white/[0.05] to-white/[0.02] rounded-2xl p-4 text-center border border-white/[0.05] group-hover:border-white/[0.08] transition-colors">
                      ...
                      <span className="text-white font-black text-xl">
                        {plan.validity}
                        <span className="text-gray-400 text-xs font-medium mr-1">يوم</span>
                      </span>
                    </div>
                  </div>

                  {/* Features */}
                  <ul className="flex flex-col gap-2.5 mb-6 flex-grow relative z-10">
                  ...
                  {/* Divider */}
                  <div className="h-px bg-gradient-to-r from-transparent via-white/10 to-transparent mb-5 relative z-10" />

                  {/* Footer */}
                  <div className="flex items-center justify-between relative z-10 mt-auto">
                    <div>
                      <span className="block text-gray-500 text-[11px] font-medium mb-0.5">السعر</span>
                    ...
                    <button
                      onClick={() => navigate(`/checkout?planId=${plan.id}&qty=1`)}
