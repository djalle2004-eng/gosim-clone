    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-50">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 border border-slate-200 text-cyan-400 font-medium mb-6">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-slate-800 leading-tight mb-6 tracking-tight">
              ابق متصلاً في{' '}
            ...
            <div className="relative max-w-xl mx-auto lg:mx-0 mb-10 group">
              ...
              <input
                ...
                className="w-full bg-slate-100 border border-slate-200 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 rounded-2xl py-5 pr-14 pl-6 text-slate-800 text-lg outline-none transition-all placeholder:text-slate-400 shadow-xl"
              />
              <button
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black p-6 pt-12 flex flex-col items-center">
                <div className="w-full bg-slate-200 rounded-2xl p-4 mb-4 border border-slate-200/50">
                ...
                <div className="mt-auto w-full bg-white rounded-2xl p-4 aspect-square flex items-center justify-center relative overflow-hidden group border-4 border-slate-200">
                ...
                <p className="text-slate-800 font-medium mt-4 text-sm bg-slate-200 px-4 py-2 rounded-full">
                  امسح لتفعيل الشبكة
                </p>
              </div>
            </motion.div>
