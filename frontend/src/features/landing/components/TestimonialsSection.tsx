  ...
  const testimonials = [
    {
      ...
      content: 'خدمة خرافية! وصلت باريس وشغلت الـ eSIM قبل ما أنزل من الطيارة. الإنترنت سريع جداً ولا يوجد أي تقطيع.',
      rating: 5,
    },
    {
      id: 2,
      ...
      content: 'أفضل خيار لرحلات العمل المتكررة. اشتريت باقة أوروبا وارتحت من هم تبديل الشرائح في كل دولة.',
      rating: 5,
    },
    {
      id: 3,
      ...
      content: 'أسعار ممتازة جداً مقارنة بالشركات المحلية. التفعيل أخذ مني دقيقة واحدة فقط. أنصح به بشدة.',
      rating: 4,
    },
    {
      id: 4,
      ...
      content: 'كنت أشارك صوري من تركيا في نفس اللحظة بفضل سرعة 5G. تجربة لا تُنسى وسأعتمد عليهم دائماً.',
      rating: 5,
    },
  ];
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`h-2 rounded-full transition-all ${
                index === currentIndex ? 'w-8 bg-cyan-500' : 'w-2 bg-slate-300 hover:bg-slate-400'
              }`}
            />
          ))}
        </div>
