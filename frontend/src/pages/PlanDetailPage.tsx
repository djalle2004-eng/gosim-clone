      ...
      <main className="flex-grow pt-24 pb-20 container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start relative">
          ...
          <div className="lg:w-2/3 w-full">
            {/* Header */}
            <div className="bg-white/90 backdrop-blur-md border border-slate-200/50 rounded-3xl p-8 mb-8 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 relative z-10 text-center md:text-right">
                ...
                <div>
                  <div className="flex items-center justify-center md:justify-start gap-3 mb-3">
                    <span className="bg-slate-200 text-slate-800 text-xs px-3 py-1 rounded-full">
                      {plan.country?.region}
                    </span>
                    {plan.speed === '5G' && (
                  ...
                  >
                    ...
                    <span className="font-bold text-slate-800 ml-2 text-lg">
                      4.9
                    </span>
                    <span className="text-slate-400 text-sm">(124 تقييم)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Tabs Trigger */}
            <div className="flex overflow-x-auto no-scrollbar gap-4 mb-6 border-b border-slate-200 pb-4">
              {[
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-full font-bold transition-all whitespace-nowrap ${activeTab === tab.id ? 'bg-cyan-500 text-background' : 'bg-transparent text-slate-500 hover:text-slate-900 hover:bg-slate-100'}`}
                >
                  {tab.label}
                </button>
              ))}
              ...
              >
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-white/90 backdrop-blur-md border border-slate-200/50 p-4 rounded-2xl flex flex-col items-center justify-center text-center">
                    ...
                    <span className="text-slate-500 text-sm">التغطية</span>
                  ...
                  <div className="bg-white/90 backdrop-blur-md border border-slate-200/50 p-4 rounded-2xl flex flex-col items-center justify-center text-center">
                    ...
                    <span className="text-slate-500 text-sm">المكالمات</span>
                    <span className="text-slate-800 font-bold">بيانات فقط</span>
                  </div>
                </div>

                <div className="bg-white/90 backdrop-blur-md border border-slate-200/50 p-6 rounded-3xl">
            ...
            {activeTab === 'activation' && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="bg-white/90 backdrop-blur-md border border-slate-200/50 p-6 md:p-10 rounded-3xl"
              >
                ...
                <div className="space-y-8 relative">
                  <div className="absolute top-0 bottom-0 right-[25px] w-0.5 bg-slate-200 hidden md:block z-0"></div>
                  ...
                  {[
                    ...
                    <div key={idx} className="flex gap-6 relative z-10">
                      <div className="w-12 h-12 bg-gradient-to-r from-violet-600 to-cyan-500 rounded-full flex items-center justify-center font-bold text-slate-800 shrink-0 shadow-lg shadow-cyan-500/20">
                        {idx + 1}
                      </div>
                      <div className="pt-2">
                ...
                <div className="mt-8 p-4 bg-slate-100 border border-slate-200 rounded-2xl flex flex-col md:flex-row items-center gap-6 justify-between filter grayscale blur-[2px] opacity-60">
            ...
            {activeTab === 'reviews' && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-center py-20 bg-white/90 backdrop-blur-md rounded-3xl border border-slate-200/50"
              >
                <Star className="w-16 h-16 text-slate-800/10 mx-auto mb-4" />
          ...
          <div className="lg:w-1/3 w-full lg:sticky lg:top-24">
            <div className="bg-white/90 backdrop-blur-md border border-slate-200 p-8 rounded-[2rem] shadow-2xl relative overflow-hidden group">
              {/* Animated glow */}
              ...
              <div className="mb-8 border-b border-slate-200 pb-8 text-center text-slate-800">
                <span className="block text-slate-400 text-sm font-medium mb-3">
                  السعر الإجمالي
                </span>
              ...
              <div className="mb-6 bg-slate-50 rounded-2xl border border-slate-200/50 p-4">
                ...
                <div className="flex justify-between items-center mb-2">
                  <span className="text-slate-500">حجم البيانات:</span>
                  <span className="font-bold text-slate-800">
                ...
                {plan.retailPrice && (
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500">سعر التوفير:</span>
              ...
              <div className="flex items-center justify-between mb-8 bg-slate-50 border border-slate-200/50 p-2 rounded-2xl">
                <button
                  onClick={() => setQuantity(Math.max(1, quantity - 1))}
                  className="w-12 h-12 flex items-center justify-center bg-slate-100 hover:bg-slate-200 rounded-xl text-slate-800 transition-colors"
                >
                  <Minus className="w-5 h-5" />
                </button>
                <div className="text-xl font-bold flex-1 text-center text-slate-800">
                  {quantity}
              ...
              <button
                ...
                className="w-full relative overflow-hidden group/btn bg-slate-100 text-slate-800 py-5 rounded-2xl font-bold text-lg transition-all border border-slate-200 hover:border-transparent mb-4 shadow-xl shadow-cyan-500/10 hover:shadow-cyan-500/30"
              >
              ...
              <button className="w-full py-4 rounded-xl font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 transition-colors border border-slate-200/50">
