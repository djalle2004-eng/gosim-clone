      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="bg-background border border-white/10 rounded-xl py-2 pr-10 pl-4 outline-none focus:border-cyan-500 text-white text-sm"
          />
        </div>
      </div>
        ...
        {selectedOrder && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-card w-full max-w-xl rounded-3xl overflow-hidden relative z-10 border border-white/10 shadow-2xl"
            >
